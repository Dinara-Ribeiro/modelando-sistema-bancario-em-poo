...
class Conta:
    ...
    def sacar(self, valor):
        ...
        if excedeu_saldo:
            print("\nXXX Falha! Você não tem saldo suficiente. XXX")
            ...
            print("\nXXX Falha! O valor informado é inválido. XXX")
...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor):
        ...
        if excedeu_limite:
            print("\nXXX Falha! O valor do saque excede o limite. XXX")

        elif excedeu_saques:
            print("\nXXX Falha! Número máximo de saques excedido. XXX")
...
def recuperar_conta_cliente(cliente):
    if not cliente.contas:
        print("\nXXX Falha!Cliente não possui conta! XXX")
        return
...
def depositar(clientes):
    ...
    if not cliente:
        print("\nXXX Falha!Cliente não encontrado! XXX")
        return
